...
function getClient(clientConfig, createReactClientOpts) {
    ...
    if ((0, isObject_1.default)(createReactClientOpts)) {
        reactClientOpts = (0, merge_1.default)(reactClientOpts, createReactClientOpts);
    }
    ...
    const haveServerContext = (0, isObject_1.default)((_a = clientConfig.context) === null || _a === void 0 ? void 0 : _a.apiClient);
    let nextClient;
    function useClient() {
        var _a;
        let client = (_a = (0, react_2.useContext)(exports.FaustContext)) === null || _a === void 0 ? void 0 : _a.client;
        if (haveServerContext || !(0, isObject_1.default)(client)) {
            client = nextClient;
        }
        return client;
    }
    ...
    const hooks = (0, hooks_1.createHooks)(useClient);
    const authHooks = (0, hooks_1.createAuthHooks)(useAuthClient);
    ...
    function setAsRoot() {
        ...
        nextClient.setAsRoot = noop_1.default;
    }
    nextClient = {
        client: coreClient,
        ...reactClient,
