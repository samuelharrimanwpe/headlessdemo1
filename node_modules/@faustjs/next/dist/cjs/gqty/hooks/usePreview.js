...
function create(useAuth, useQuery) {
    function usePreview() {
        ...
        const { query: { p, page_id: pageId }, } = (0, router_1.useRouter)();
        ...
        if ((0, isUndefined_1.default)(isAuthenticated) || isAuthenticated !== true) {
            return;
        }
        if ((0, utils_1.hasPageId)(args)) {
            const page = pageQuery({
                id: (_a = args === null || args === void 0 ? void 0 : args.pageId) !== null && _a !== void 0 ? _a : '',
                idType: client_1.PageIdType.DATABASE_ID,
            });
