...
function create() {
    return (useAuthOptions) => {
        const options = (0, defaults_1.default)({}, useAuthOptions, {
            shouldRedirect: true,
        });
        ...
        (0, react_1.useEffect)(() => {
            ...
            (async () => {
                ...
                const auth = await (0, auth_1.ensureAuthorization)({
                    ...
                    loginPageUri: `/${(0, trim_1.default)(loginPagePath, '/')}/?redirect_uri=${encodeURIComponent(window.location.href)}`,
                });
                if (!mounted) {
                    return;
                }
        ...
        (0, react_1.useEffect)(() => {
            ...
            const timeout = setTimeout(() => {
                if (!(0, isObject_1.default)(authResult)) {
                    return;
                }
