...
const isArrayLike_1 = __importDefault(require("lodash/isArrayLike"));
...
function base64Decode(str) {
    if (!(0, assert_1.isBase64)(str)) {
        return str;
    }
    if ((0, assert_1.isServerSide)()) {
...
function parseUrl(url) {
    ...
    if (!(0, isArrayLike_1.default)(parsed) ||
        (0, isEmpty_1.default)(parsed) ||
        ((0, isUndefined_1.default)(parsed[4]) && url[0] !== '/')) {
        return;
    }
    return {
        href: parsed[0],
...
function getQueryParam(url, param) {
    if (!(0, isString_1.default)(url) || !(0, isString_1.default)(param) || (0, isEmpty_1.default)(url) || (0, isEmpty_1.default)(param)) {
        return '';
    }
    const parsedUrl = parseUrl(url);
    if ((0, isUndefined_1.default)(parsedUrl) || !(0, isString_1.default)(parsedUrl.search)) {
        return '';
    }
...
function getUrlPath(url) {
    const parsedUrl = parseUrl(url);
    if ((0, isUndefined_1.default)(parsedUrl)) {
        return '/';
    }
