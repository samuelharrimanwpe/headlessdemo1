...
import { lexicographicSortSchema, parse, isScalarType, isObjectType, isInterfaceType, isUnionType, isEnumType, isInputObjectType, isNullableType } from 'graphql';
...
` : "";
  ...
  const interfacesOfObjectTypesMap = new Map();
  ...
  const unionsAndInterfacesObjectTypesMap = new Map();
